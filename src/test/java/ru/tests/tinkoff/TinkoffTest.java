...
public class TinkoffTest extends WebDriverSettings {
    ...
    public void testTinkoff() {
        ...
        // Шаг №2
        mainPage.paymentsButtonClick();//жмем на кнопку "Платежи"

        // Шаг №3
        paymentsPage.zkhButtonClick(); //жмем на кнопку "ЖКХ"

        // Шаг №4
        assertTrue(zkhPage.getRegionName().equals("Москве"));

        // Шаг №5
        zkhPage.zkuMoscowButtonClick(); //жмем на кнопку "ЖКУ-Москва"
        String zhkumoskvapage = driver.getCurrentUrl(); //сохраняем адрес страницы

        // Шаг №6
        zkhPage.zkuMoscowPayClick(); //жмем на кнопку "Оплатить ЖКУ в Москве"

        // Шаг №7
        zkhPage.payButtonClick(); //жмем на кнопку "Оплатить"
        ...
        // Шаг №8
        zkhPage.paymentsButtonClick(); //жмем на кнопку "Платежи";
